...
\IEEEauthorblockA{\url{https://github.com/jkarppi/RadioChannelSense}}%
}
...
\input{sections/04-otaniemi}
\input{sections/05-radio}
\input{sections/06-dataset}
\input{sections/07-evaluation}
\input{sections/08-localization}
\input{sections/09-channel_charting}
...
\url{https://github.com/jkarppi/RadioChannelSense}.
